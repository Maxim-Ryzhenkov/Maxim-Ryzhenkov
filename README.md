...
## Hello! My name is Maxim Ryzhenkov.

**I've been doing Python test automation since 2013**.<br>
**Currently working as a Lead Software Automation Engineer at Artec 3D**.

Briefly about me:<br>
I develop and maintain a test automation system.<br> I write autotests for GUI testing of the Artec Studio desktop application.<br> The application works with external 3D scanners, can create and edit 3D models and CAD objects.<br>My product is a test one a Python framework that allows you to write UI tests for all this.

- I participate in the transfer of knowledge within the team, write documentation and document the code, add use cases.
- I can not only write code, but also communicate with people, I have a higher education in clinical psychology.
- I can work with Python libraries for data processing and analysis: numpy, pandas, opencv.
- With libraries and frameworks for testing: pytest, selenium, allure, squish.
- I have development experience with Flask and Django.
